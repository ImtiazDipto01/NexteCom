...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> implements Filterable {
    ...
    private List<HomeProducts> original_items = new ArrayList<>();
    private List<HomeProducts> filtered_items = new ArrayList<>();
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int position, HomeProducts obj);
    }
    ...
    public CartListAdapter(Context ctx, List<HomeProducts> items) {
        this.ctx = ctx;
...
//        v.setBackgroundResource(mBackground);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final HomeProducts p = filtered_items.get(position);
...
//        }
//        else{
//            Picasso.with(ctx).load(R.drawable.c_f_7)
//                    .resize(350,400)
//                    .into(holder.image);
//        }
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<HomeProducts> list = original_items;
            final List<HomeProducts> result_list = new ArrayList<>(list.size());
...
//                }
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filtered_items = (List<HomeProducts>) results.values;
